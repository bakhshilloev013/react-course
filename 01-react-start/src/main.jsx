...
// пример построения элементов в React без jsx кода. P.S: все jsx коды загружается на страницу в таком ниже указанном виде под средством технологии Babel
// метод createElement() принимает 3 аргумента: 1) какой html тег создать 2) объект с атрибутами(их тут называют свойствами) 3) значение внутри тега
